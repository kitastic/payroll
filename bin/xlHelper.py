...
# wb_target = openpyxl.load_workbook('weeklyPayroll.xlsx')
# target_sheet = wb_target.create_sheet('test')
#
# wb_source = openpyxl.load_workbook('../p.3.20.2023.xlsx', data_only=True)
...
#
# wb_target.save('weeklyPayroll.xlsx')